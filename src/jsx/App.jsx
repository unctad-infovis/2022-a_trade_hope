...
function App() {
  ...
  return (
    <div className="app">
      ...
      <div className="background">
        <div className="content_container">
          <h3>The Initiative has become a trade hope for the world and particularly for developing countries.</h3>
      ...
      <ChartContainer src="https://datawrapper.dwcdn.net/uAhX8/1/" title="Wheat is a pillar of food security, and it is going where it is most needed" />
      ...
      <ChartContainer src="https://datawrapper.dwcdn.net/jg2jj/3/" title="Maize and wheat prices are again rising" />
      <div className="background">
        <div className="content_container">
